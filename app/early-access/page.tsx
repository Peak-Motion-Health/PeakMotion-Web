      ...
      <section className="mx-auto mt-20 grid max-w-6xl gap-10 md:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-2xl">
          ...
          <form className="mt-8 space-y-5">
            <Field label="Full Name" placeholder="Drew Pate" />
            <Field label="Email" placeholder="drew.pate@peakmotionhealth.com" type="email" />
            <Field label="Role" placeholder="SPT, PT, PTA, OT, AT, Clinic Owner..." />
            <Field label="School / Clinic" placeholder="Your school or clinic name" />
